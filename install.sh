...
# Direktori untuk mengunduh paket
mkdir -p lib && cd lib

# Membuat daftar MD5 untuk file yang diunduh
cat > lib-7.md5 << "EOF"
...
# Membuat fungsi untuk menjalankan perintah sebagai root
as_root() {
    if [ $EUID = 0 ]; then
        $*
...
# Skrip selesai
echo "Xorg Libraries telah terinstal."
